...
<html>
	<head>
		...
		<style>/*! Generated by Font Squirrel (https://www.fontsquirrel.com) on September 7, 2017 */
...
.whitetext, #xy-display, #chat, #dev-chat, #playercount-display {
	color: #FFF;
	font: 16px pixel-op, sans-serif;
...
#load-scr {
	...
	font: 0/0 a;
	pointer-events: none;
	transition: -webkit-transform 1.5s cubic-bezier(0.68, -0.55, 0.27, 1.55);
	transition: transform 1.5s cubic-bezier(0.68, -0.55, 0.27, 1.55);
	transition: transform 1.5s cubic-bezier(0.68, -0.55, 0.27, 1.55), -webkit-transform 1.5s cubic-bezier(0.68, -0.55, 0.27, 1.55);
	background-image: url(/img/unloaded.png);
...
#windows > div, .winframe { /* Frame */
	...
	border-width: 11px;
	-o-border-image: url(/img/window_out.png) 11 repeat;
...
#windows > div > div > input {
	border: 6px #7e635c solid;
	-o-border-image: url(/img/small_border.png) 6 repeat;
...
button {
	...
	-o-border-image: url(/img/button.png) 6 repeat;
	   border-image: url(/img/button.png) 6 repeat;
	background-color: #aba389;
...
button:active {
	border-style: inset;
	-o-border-image: url(/img/button_pressed.png) 6 repeat;
	   border-image: url(/img/button_pressed.png) 6 repeat;
...
#xy-display, #playercount-display, #palette {
	position: absolute;
	pointer-events: none;
...
#playercount-display, #xy-display, #palette-create, #palette, .framed {
	border: 5px #aba389 solid;
	-o-border-image: url(/img/small_border.png) 5 repeat;
	   border-image: url(/img/small_border.png) 5 repeat;
	border-image-outset: 1px;
...
#chat, #dev-chat {
	...
	pointer-events: none;
	overflow: hidden;
	transition: background-color 0.2s, box-shadow 0.2s, -webkit-transform 0.75s;
	transition: background-color 0.2s, box-shadow 0.2s, transform 0.75s;
	transition: background-color 0.2s, box-shadow 0.2s, transform 0.75s, -webkit-transform 0.75s;
...
#captchawdow {
	...
	<link rel="shortcut icon" href="/favicon.ico"><script type="text/javascript" src="/app.ab349cb98da11853b5e2.js" async></script></head>
	<body>
		<div id="viewport">
		...
		<div id="load-scr">
			<ul id="load-ul">
				<li>
					<img id="logo" src="/img/owop.png" width="224px" height="190px" alt="Our World Of Pixels" draggable="false"/>
				</li>
				<noscript>
		...
		<div id="help" class="hidden">
			...
			<div class="content whitetext">
				<div class="links">
					<a target="_blank" href="http://ourworldofpixels.gamepedia.com/"><img src="/img/wiki.png" /></a>
					<a target="_blank" href="https://owop.me/discord"><img src="/img/discord.png" /></a>
				...
				<ul>
					...
					<li><b>F2</b> - Hide other cursors</li>
					<li><b>G</b> - Toggle grid</li>
					<li><b>H</b> - Toggle protection outlines</li>
